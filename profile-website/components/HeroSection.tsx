        ...
        <div className="">
          ...
          >
            ...
            >
              <a 
                href="#contact"
                className="py-3 text-xs rounded-full bg-gradient-to-r from-gray-800 via-gray-900 to-black font-medium flex items-center justify-center gap-2 hover:opacity-70 transition-opacity"
              >
                Contact Me
                <ArrowRight size={20} />
              </a>
              ...
              <a 
                href="#projects"
                className="py-3 text-xs rounded-full border-4 border-gray-800 text-white font-medium hover:bg-gray-900 transition-colors flex items-center justify-center gap-2"
              >
                View Projects
                <EyeIcon size={20} />
              </a>
